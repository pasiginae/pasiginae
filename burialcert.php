                        ...
                        <div class="container py-5" id="page-container">
                            <div class="col-sm-12">
                                <div class="form-box" style="position: relative;">
                                    <div class="form-title">BURIAL REQUEST CERTIFICATES <img src="assets/img/logo.png" alt="Company Logo" width="100" height="150" style="float: right;"></div> <br>
                                    <a href="card2certificate.html" class="btn btn-secondary mb-3"><i class="fas fa-arrow-left"></i> Back</a>
                                    <form method="post" action="burialformconnect.php" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-sm-6">
