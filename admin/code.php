...
if(isset($_POST['update_user']))
{
    ...
    $query = "UPDATE users SET first_name='$first_name', middle_name='$middle_name', surname='$surname', suffix='$suffix', sex='$sex', username='$username', email='$email', mobile_no='$mobile_no', parish='$parish', address='$address', region_text='$region', province_text='$province', city_text='$city', barangay_text='$barangay', street_text='$street',zip='$zip', role='$role', password='$password', status='$status'
                WHERE id='$user_id' ";
    $query_run = mysqli_query($con, $query);
